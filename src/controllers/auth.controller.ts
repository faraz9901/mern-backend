...
export const verifyEmail = async (req: Request, res: Response) => {
    ...
    const isMatch = await argon2.verify(otp, otpDoc.otp);
    if (!isMatch) {
    ...
    return new AppResponse(200, "Email verified successfully", null).send(res);
};
...
export const login = async (req: Request, res: Response) => {
    ...
    return new AppResponse(200, "Code sent to your email", null).send(res);
};
